...
template <class T>
using OptionalBase =
    typename std::conditional<is_trivially_destructible<T>::value, constexpr_optional_base<typename std::remove_const<T>::type>,
...
class optional : private OptionalBase<T> {
   ...
   public:
    ...
    T& value() { return initialized() ? contained_val() : (valijson::throwRuntimeError("bad optional access"), contained_val()); }
...
class optional<T&> {
   ...
   public:
    ...
    constexpr T& value() const { return ref ? *ref : (valijson::throwRuntimeError("bad optional access"), *ref); }
