...
vktrace_SettingInfo g_settings_info[] =
{
    ...
    { "s", "ScreenShot", VKTRACE_SETTING_STRING, { &g_settings.screenshotList }, { &g_default_settings.screenshotList }, TRUE, "Get screenshots with comma separated list of frames, <start>-<count>-<interval> or <all>."},
...
int main(int argc, char* argv[])
{
    ...
    if (g_settings.screenshotList)
    {
        ...
        if (!screenshot::checkParsingFrameRange(g_settings.screenshotList, &frameRangeErrorMessage))
        {
