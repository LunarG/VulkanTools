...
class SettingsTreeManager : QObject {
   ...
   private:
    ...
    void BuildKhronosTree(const std::vector<Preset> &presets, const Layer &layer, ConfigurationLayer &parameter);
    void BuildGenericTree(QTreeWidgetItem *parent, const Layer &layer, ConfigurationLayer &parameter);
