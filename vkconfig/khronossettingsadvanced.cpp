...
TABLE_ENTRY lookupTable[17] = {
    { "VK_VALIDATION_FEATURE_DISABLE_CORE_CHECKS_EXT",
     ...
     { "VALIDATION_CHECK_DISABLE_COMMAND_BUFFER_STATE",
      "Command buffer state core validation checks.",
      "" },
...
static TREE_SETTING coreChecks[NUM_CORE_CHECKS] = { { "Image Layout Validation", "VALIDATION_CHECK_DISABLE_IMAGE_LAYOUT_VALIDATION", nullptr},
...
static TREE_SETTING miscDisables[NUM_MISC_DISABLES] = { { "Thread Safety Checks", "VK_VALIDATION_FEATURE_DISABLE_THREAD_SAFETY_EXT", nullptr},
