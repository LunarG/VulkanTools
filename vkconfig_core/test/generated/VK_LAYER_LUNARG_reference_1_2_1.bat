...
set VK_LOADER_LAYERS_ENABLE=VK_LAYER_LUNARG_reference_1_2_1
...
::  true or false
set VK_LUNARG_REFERENCE_1_2_1_TOOGLE=true

:: enum
:: ------------------------------------------
:: enum_required_only (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS)
::  enum case
set VK_LUNARG_REFERENCE_1_2_1_ENUM_REQUIRED_ONLY=value1
...
:: - set VK_LUNARG_REFERENCE_1_2_1_TOOGLE=true
set VK_LUNARG_REFERENCE_1_2_1_ENUM_WITH_OPTIONAL=value1

:: flags
:: ------------------------------------------
:: flags_required_only (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS)
::  flags case
set VK_LUNARG_REFERENCE_1_2_1_FLAGS_REQUIRED_ONLY=flag0,flag1
...
:: This setting requires ALL of the following values:
:: - set VK_LUNARG_REFERENCE_1_2_1_TOOGLE=true
set VK_LUNARG_REFERENCE_1_2_1_FLAGS_WITH_OPTIONAL=flag0,flag1

:: String
:: ------------------------------------------
:: string_required_only (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS)
::  string
set VK_LUNARG_REFERENCE_1_2_1_STRING_REQUIRED_ONLY=A string
...
:: This setting requires ALL of the following values:
:: - set VK_LUNARG_REFERENCE_1_2_1_TOOGLE=true
set VK_LUNARG_REFERENCE_1_2_1_STRING_WITH_OPTIONAL=A string

:: bool
:: ------------------------------------------
:: bool_required_only (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS)
::  true or false
set VK_LUNARG_REFERENCE_1_2_1_BOOL_REQUIRED_ONLY=true
...
:: This setting requires ALL of the following values:
:: - set VK_LUNARG_REFERENCE_1_2_1_TOOGLE=true
set VK_LUNARG_REFERENCE_1_2_1_BOOL_WITH_OPTIONAL=true

:: Load file
:: ------------------------------------------
:: load_file_required_only (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS)
::  Load file path
set VK_LUNARG_REFERENCE_1_2_1_LOAD_FILE_REQUIRED_ONLY=./test.txt
...
:: This setting requires ALL of the following values:
:: - set VK_LUNARG_REFERENCE_1_2_1_TOOGLE=true
set VK_LUNARG_REFERENCE_1_2_1_LOAD_FILE_WITH_OPTIONAL=./test.json

:: Save file
:: ------------------------------------------
:: save_file_required_only (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS)
::  Save file path
set VK_LUNARG_REFERENCE_1_2_1_SAVE_FILE_REQUIRED_ONLY=./test.json
...
:: This setting requires ALL of the following values:
:: - set VK_LUNARG_REFERENCE_1_2_1_TOOGLE=true
set VK_LUNARG_REFERENCE_1_2_1_SAVE_FILE_WITH_OPTIONAL=./test.json

:: Save folder
:: ------------------------------------------
:: save_folder_required_only (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS)
::  Save folder path
set VK_LUNARG_REFERENCE_1_2_1_SAVE_FOLDER_REQUIRED_ONLY=./test
...
:: This setting requires ALL of the following values:
:: - set VK_LUNARG_REFERENCE_1_2_1_TOOGLE=true
set VK_LUNARG_REFERENCE_1_2_1_SAVE_FOLDER_WITH_OPTIONAL=./test

:: Integer
:: ------------------------------------------
:: int_required_only (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS)
::  Integer Description
set VK_LUNARG_REFERENCE_1_2_1_INT_REQUIRED_ONLY=76
...
:: This setting requires ALL of the following values:
:: - set VK_LUNARG_REFERENCE_1_2_1_TOOGLE=true
set VK_LUNARG_REFERENCE_1_2_1_INT_WITH_OPTIONAL=76

:: Float
:: ------------------------------------------
:: float_required_only (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS)
::  Float Description
set VK_LUNARG_REFERENCE_1_2_1_FLOAT_REQUIRED_ONLY=76.500000
...
:: This setting requires ALL of the following values:
:: - set VK_LUNARG_REFERENCE_1_2_1_TOOGLE=true
set VK_LUNARG_REFERENCE_1_2_1_FLOAT_WITH_OPTIONAL=76.500

:: Frames
:: ------------------------------------------
:: frames_required_only (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS)
::  Frames Description
set VK_LUNARG_REFERENCE_1_2_1_FRAMES_REQUIRED_ONLY=76-82,75
...
:: This setting requires ALL of the following values:
:: - set VK_LUNARG_REFERENCE_1_2_1_TOOGLE=true
set VK_LUNARG_REFERENCE_1_2_1_FRAMES_WITH_OPTIONAL=76-82,75

:: List
:: ------------------------------------------
:: list_required_only (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS)
::  List description
set VK_LUNARG_REFERENCE_1_2_1_LIST_REQUIRED_ONLY=76,82,stringB,stringD
...
:: This setting requires ALL of the following values:
:: - set VK_LUNARG_REFERENCE_1_2_1_TOOGLE=true
set VK_LUNARG_REFERENCE_1_2_1_LIST_WITH_OPTIONAL=76,82,stringB,stringD
...
::  List description
:: For more information about the feature: https://vulkan.lunarg.com/doc/sdk/latest/windows/layer_dummy.html#list
set VK_LUNARG_REFERENCE_1_2_1_LIST_EMPTY=
