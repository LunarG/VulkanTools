...
TEST(test_setting_type_frames, meta_equal) {
    ...
    SettingMetaFrames* meta0 = Instantiate<SettingMetaFrames>(layer, "key");
    meta0->default_value = "6-7";
    SettingMetaFrames* meta1 = Instantiate<SettingMetaFrames>(layer, "key");
...
TEST(test_setting_type_frames, data_equal) {
    ...
    SettingMetaFrames* meta = Instantiate<SettingMetaFrames>(layer, "key");
    ...
    SettingMetaFrames* metaX = Instantiate<SettingMetaFrames>(layer, "keyX");
