...
:: set VK_KHRONOS_VALIDATION_GPUAV_MAX_BUFFER_DEVICE_ADDRESSES=10000 (Commented out as the set of dependences is not satisfied)
...
:: This setting requires ALL of the following values:
:: - set VK_KHRONOS_VALIDATION_GPUAV_ENABLE=true
:: set VK_KHRONOS_VALIDATION_GPUAV_RESERVE_BINDING_SLOT=true (Commented out as the set of dependences is not satisfied)
...
:: This setting requires ALL of the following values:
:: - set VK_KHRONOS_VALIDATION_GPUAV_ENABLE=true
:: set VK_KHRONOS_VALIDATION_GPUAV_VMA_LINEAR_OUTPUT=true (Commented out as the set of dependences is not satisfied)
...
set VK_LUNARG_CRASH_DIAGNOSTIC_TRACE_ALL_SEMAPHORES=false
...
::  physical device.
set VK_KHRONOS_PROFILES_FORCE_DEVICE=FORCE_DEVICE_OFF

:: Device UUID - force_device_uuid
:: ==========================================
::  Device UUID of the forced physical devices
set VK_KHRONOS_PROFILES_FORCE_DEVICE_UUID=

:: Device Name - force_device_name
:: ==========================================
::  Device Name of the forced physical devices
set VK_KHRONOS_PROFILES_FORCE_DEVICE_NAME=${VP_PHYSICAL_DEVICES}
