...
enum PlatformString {
    ...
    PLATFORM_STRING_PATH_CONFIGURATION_2_0_X,
    PLATFORM_STRING_PATH_CONFIGURATION_2_1_0,
    PLATFORM_STRING_PATH_CONFIGURATION_2_2_0,
    PLATFORM_STRING_PATH_CONFIGURATION_2_2_1,
    PLATFORM_STRING_PATH_OVERRIDE_LAYERS,
    PLATFORM_STRING_PATH_OVERRIDE_SETTINGS,

    PLATFORM_STRING_PATH_CONFIGURATION_FIRST = PLATFORM_STRING_PATH_CONFIGURATION_2_0_X,
    PLATFORM_STRING_PATH_CONFIGURATION_LAST = PLATFORM_STRING_PATH_CONFIGURATION_2_2_1,
