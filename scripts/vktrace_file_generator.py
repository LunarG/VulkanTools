...
class VkTraceFileOutputGenerator(OutputGenerator):
    ...
    def GenerateTraceVkHeader(self):
        ...
        trace_vk_hdr += '#elif defined(PLATFORM_LINUX) || defined(PLATFORM_BSD)\n'
        trace_vk_hdr += 'void InitTracer(void);\n'
    ...
    def GenerateTraceVkSource(self):
        ...
        trace_vk_src += '#if defined(PLATFORM_LINUX) || defined(PLATFORM_BSD)\n'
        ...
        trace_vk_src += '#elif defined(PLATFORM_LINUX) || defined(PLATFORM_BSD)\n'
