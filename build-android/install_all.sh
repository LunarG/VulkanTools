...
echo "adb $serialFlag install -r ../submodules/Vulkan-Tools/cube/android/cube/bin/cube.apk"
adb $serialFlag install -r ../submodules/Vulkan-Tools/cube/android/cube/bin/cube.apk
echo "adb $serialFlag install -r ../submodules/Vulkan-Tools/cube/android/cube-with-layers/bin/cube-with-layers.apk"
adb $serialFlag install -r ../submodules/Vulkan-Tools/cube/android/cube-with-layers/bin/cube-with-layers.apk
