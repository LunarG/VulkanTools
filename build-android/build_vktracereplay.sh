...
mkdir -p build
cd build
cmake -DCMAKE_BUILD_TYPE=Debug -DBUILD_TESTS=Off -DBUILD_VLF=Off -DBUILD_VKTRACEVIEWER=Off -DBUILD_APIDUMP=Off -DBUILD_MONITOR=Off -DBUILD_SCREENSHOT=Off -DBUILD_DEVSIM=Off -DBUILD_VIA=Off -DBUILD_VKTRACE_LAYER=Off -DBUILD_VKTRACE_REPLAY=Off -DBUILD_LAYERS=Off -DBUILD_LAYER_SUPPORT_FILES=On -DBUILD_VKTRACE=On ..
make -j $cores
popd
)
...
mkdir -p build32
cd build32
cmake -DCMAKE_BUILD_TYPE=Debug -DBUILD_TESTS=Off -DBUILD_VLF=Off -DBUILD_VKTRACEVIEWER=Off  -DBUILD_APIDUMP=Off -DBUILD_MONITOR=Off -DBUILD_SCREENSHOT=Off -DBUILD_DEVSIM=Off -DBUILD_VIA=Off -DBUILD_VKTRACE_LAYER=Off -DBUILD_VKTRACE_REPLAY=Off -DBUILD_LAYERS=Off -DBUILD_LAYER_SUPPORT_FILES=On -DBUILD_X64=Off -DBUILD_VKTRACE=On ..
make -j $cores
popd
)
